...
SECRET_KEY = 'uz9$jhaoxwb%0lhb!ok)r!*g16yvty_7#6)6-k$5yr48(&_it6'
...
STATIC_ROOT = os . path . join ( PROJECT_ROOT , 'staticfiles' ) STATIC_URL = '/static/' # Extra places for collectstatic to find static files. 
